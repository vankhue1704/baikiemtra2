 ...
 *     description: Only admins can create other students.
 *     tags: [Students]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 ...
 *     description: Logged in students can fetch only their own student information. Only admins can fetch other students.
 *     tags: [Students]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in students can only update their own information. Only admins can update other students.
 *     tags: [Students]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in students can delete only themselves. Only admins can delete other students.
 *     tags: [Students]
 *     security:
 *       - bearerAuth: []
 *     parameters:
